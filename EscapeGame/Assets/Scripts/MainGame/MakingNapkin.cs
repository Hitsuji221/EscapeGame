...
public class MakingNapkin : MonoBehaviour
{
    ...
    public void OnClickPen(){
        if(currentPanelStr == "Image1"){ //Panel0のstomacgirlを表示
            this.transform.localPosition=new Vector2(-7200,3000);
            ...
            this.transform.localPosition=new Vector2(-8400,3000);
     ...
     public void OnClickHasami(){
        if(currentPanelStr == "Image11"&& (kizi.activeSelf == true && pori.activeSelf == true && cotton.activeSelf == true)){ //Panel0のstomacgirlを表示
            this.transform.localPosition=new Vector2(-7200,4000);
            ...
            this.transform.localPosition=new Vector2(-8400,4000);
     ...
     public void OnClickMishin(){
        if(currentPanelStr == "Image21" && kizi2.activeSelf == true && pori2.activeSelf == true && cotton2.activeSelf == true ){ //Panel0のstomacgirlを表示
            this.transform.localPosition=new Vector2(-7200,5000);
            currentPanelStr = "Image41";
            OnClickCorrectOne();
        }else if(currentPanelStr == "Image62"&& (mkizi2.activeSelf == true)){
            this.transform.localPosition=new Vector2(-8400,5000);
    ...
    public void OnClickPanel(){
        this.transform.localPosition=new Vector2(-7200,6000);
        currentPanelStr = "Image4";
        OnClickCorrectOne();
    }
    public void OnClickNapkin(){
        this.transform.localPosition=new Vector2(-7200,7000);
    ...
    public void OnClickNextGame(){
        this.transform.localPosition=new Vector2(-8400,1000);
        currentPanelStr = "Image51";
        toolBox.SetActive(false);
        OnClickCorrectOne();
    }
    public void OnClickGameStart2(){
        this.transform.localPosition=new Vector2(-8400,2000);
        currentPanelStr = "Image6";
        toolBox.SetActive(true);
        OnClickCorrectOne();
    }
    public void OnClickMawashi(){
        this.transform.localPosition=new Vector2(-8400,6000);
    ...
    public void OnClickGattai(){
        this.transform.localPosition=new Vector2(-8400,7000);
